...
/***/ function(module, exports, __webpack_require__) {
	...
	var LineChartView = __webpack_require__(6);
	var BarChartView = __webpack_require__(7);
	var PieChartView = __webpack_require__(8);
	var RadarChartView = __webpack_require__(9);
	...
	var MainController = (function () {
	  ...
	  _createClass(MainController, [{
	    ...
	    key: 'chartClobalSetup',
	    value: function chartClobalSetup() {
	      var chartGlobal = Chart.defaults.global;
	    ...
	    key: 'parseForChart',
	    value: function parseForChart() {
	      this.labelDate = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
	      this.data = this.data.reverse();
	      this.data2015 = {};
	      this.data2015.array = _.filter(this.data, function (data) {
	        return data.year === 2015;
	      });
	      this.data2015 = {
	        temperatureArray: _.map(this.data2015.array, function (data) {
	          return data.temperature;
	        }),
	        precipitationArray: _.map(this.data2015.array, function (data) {
	          return data.precipitation;
	        }),
	        snowfallArray: _.map(this.data2015.array, function (data) {
	          return data.snowfall;
	        }),
	        humidityArray: _.map(this.data2015.array, function (data) {
	          return data.humidity;
	        })
	      };
	      this.data2014 = {};
	      this.data2014.array = _.filter(this.data, function (data) {
	        return data.year === 2014;
	      });
	      this.data2014 = {
	        temperatureArray: _.map(this.data2014.array, function (data) {
	          return data.temperature;
	        }),
	        precipitationArray: _.map(this.data2014.array, function (data) {
	          return data.precipitation;
	        }),
	        snowfallArray: _.map(this.data2014.array, function (data) {
	          return data.snowfall;
	        }),
	        humidityArray: _.map(this.data2014.array, function (data) {
	          return data.humidity;
	        })
	      };
	      return this;
	    ...
	    key: 'getDataPie',
	    value: function getDataPie() {
	      this.pieLabels = ['React', 'AngularJS', 'Backbone.js', 'Knockout.js', 'Ember.js'];
	      this.pieData = [40, 30, 15, 10, 5];
	      this.pieColors = [this.chartColor.red.hexadecimal, this.chartColor.orange.hexadecimal, this.chartColor.yellow.hexadecimal, this.chartColor.skyblue.hexadecimal, this.chartColor.blue.hexadecimal];
	      return this;
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BarChar = (function () {
		function BarChar(args) {
			_classCallCheck(this, BarChar);
